...
[SAP ERP Master Data Integration with SAP S/4HANA Cloud](saperpmasterdataintegrationwithsaps4hanacloud)| This package enables Master data integration between SAP ERP and SAP S/4HANA Cloud using SOAP and ODATA services allows you to replicate supported master data objects from SAP ERP to S/4HANA Cloud solutions.| [SAP S/4HANA](../readme.md#sap-s4hana-cloud) \| [SAP ERP](../readme.md#sap-erp)
