...
<p>This package supports you with the transformation of data in business objects of SAP Business One (B1) into a form suitable for migration into SAP S/4HANA Cloud Public Edition object.</p>
...
<ol>
 <li>B1 Customer Master Data Transformation</li>
 <li>B1 Item Master Data Transformation</li>
 <li>B1 Supplier Master Data Transformation</li>
 <li>B1 Fixed Asset Master Data Transformation&nbsp;</li>
</ol>
...
### B1 Fixed Asset Master Data Transformation 
Transform the data in Fixed Asset Master object of SAP Business One into the Fixed Asset migration template of SAP S/4HANA Cloud Public Edition, suitable for upload via Migration cockpit. \
 ![input-image](B1_Fixed_Asset_Master_Data_Transformation.png)
